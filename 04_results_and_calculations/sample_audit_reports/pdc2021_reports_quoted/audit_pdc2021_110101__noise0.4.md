...
| **Noise Threshold** | `0.4` |
| **Fitness** | `0.9290051365074338` |
| **Precision** | `0.26560726447219074` |
...
| **Data Exposure (Confirmed % of Claimed Volume)** | `95.40%` |
...
| **Max Fractional Exposure (Worst-Case Normalized)** | `2.17%` |
| **Avg Fractional Exposure (Typical-Case Normalized)** | `100.00%` |
| **Mean Absolute Exposure Volume (events/case)** | `26.55` |

---

## Original PM4Py Tree

![Original PM4Py Tree](images/orig_tree_audit_pdc2021_110101__noise0.4.png)


```text
->( 't10', X( tau, ->( X( 't06', 't11' ), X( tau, *( 't04', 't07' ) ), +( X( tau, *( 't15', tau ) ), *( 't05', tau ) ), X( tau, 't16' ) ) ), 't20', +( *( 't17', tau ), ->( *( 't21', tau ), X( tau, ->( 't24', 't23' ) ) ) ), X( tau, 't22' ), +( X( tau, *( 't34', tau ) ), ->( X( tau, ->( 't26', 't27', 't28' ) ), *( *( 't42', tau ), 't41' ), X( tau, 't71' ), +( *( 't40', tau ), ->( *( ->( 't39', X( tau, ->( 't43', *( 't44', tau ) ) ), *( 't36', tau ) ), 't32' ), *( ->( X( tau, 't46' ), X( *( 't69', tau ), *( 't70', tau ), ->( X( tau, ->( 't47', X( tau, 't37' ) ) ), X( tau, +( *( 't62', tau ), *( 't48', tau ), *( 't68', tau ) ) ), +( X( tau, *( 't52', tau ) ), *( 't55', tau ), *( 't56', tau ) ) ) ), X( tau, 't65' ) ), tau ) ) ) ) ) )
```

## Assimilated Master Tree

![Assimilated Master Tree](images/custom_tree_audit_pdc2021_110101__noise0.4.png)
...
| `[ST (in PAR_28)]` | `⟨t55⟩` | Exact Token Match | $\ge$ 622 | **622** | ✅ **VERIFIED** |
| `[ST (in LOOP_30)]` | `t56` | Exact Token Match | $\ge$ 606 | **606** | ✅ **VERIFIED** |
| `[ST (in PAR_28)]` | `⟨t56⟩` | Exact Token Match | $\ge$ 606 | **606** | ✅ **VERIFIED** |
| `[ST (in LOOP_18)]` | `⟨τ, [nested PAR_26]⟩` | Exact Token Match | $\ge$ 434 | **506** | ✅ **VERIFIED** |
| `[ST (in LOOP_18)]` | `⟨[nested PAR_21], [nested PAR_26]⟩` | Exact Token Match | $\ge$ 188 | **255** | ✅ **VERIFIED** |
| `[ST (in LOOP_18)]` | `⟨τ, τ, [nested PAR_26]⟩` | Exact Token Match | $\ge$ 244 | **506** | ✅ **VERIFIED** |
| `[ST (in LOOP_18)]` | `t65` | Exact Token Match | $\ge$ 432 | **432** | ✅ **VERIFIED** |
| `[ST (in LOOP_18)]` | `⟨τ, [nested PAR_26], τ⟩` | Exact Token Match | $\ge$ 2 | **506** | ✅ **VERIFIED** |
| `[ST (in LOOP_18)]` | `⟨[nested PAR_26], τ⟩` | Exact Token Match | $\ge$ 190 | **506** | ✅ **VERIFIED** |
...
| `[AS (in PAR_26)]` | `[nested PAR_28]` | Exact Token Match | $\ge$ 622 | **534** | ⚠️ **DISCREPANCY** |
| `[AS (in LOOP_18)]` | `[nested PAR_26]` | Exact Token Match | $\ge$ 622 | **506** | ⚠️ **DISCREPANCY** |
...
## Audit Summary
- **Perfect Pattern Verifications:** 116
...
- **Max Fractional Exposure (Worst-Case Normalized):** 2.17% (expected length: 2647.31 events)
- **Avg Fractional Exposure (Typical-Case Normalized):** 100.00% (expected length: 33.21 events)
- **Mean Absolute Exposure Volume:** 26.55 events/case
...
![nested LOOP_10 Internal Diagram](images/nested_ref_audit_pdc2021_110101_nested_LOOP_10.png)
...
![nested LOOP_13 Internal Diagram](images/nested_ref_audit_pdc2021_110101_nested_LOOP_13.png)
...
![nested LOOP_15 Internal Diagram](images/nested_ref_audit_pdc2021_110101_nested_LOOP_15.png)
...
![nested LOOP_16 Internal Diagram](images/nested_ref_audit_pdc2021_110101_nested_LOOP_16.png)
...
![nested LOOP_14 Internal Diagram](images/nested_ref_audit_pdc2021_110101_nested_LOOP_14.png)
...
![nested XOR_17 Internal Diagram](images/nested_ref_audit_pdc2021_110101_nested_XOR_17.png)
...
![nested LOOP_25 Internal Diagram](images/nested_ref_audit_pdc2021_110101_nested_LOOP_25.png)
...
![nested PAR_23 Internal Diagram](images/nested_ref_audit_pdc2021_110101_nested_PAR_23.png)
...
![nested PAR_21 Internal Diagram](images/nested_ref_audit_pdc2021_110101_nested_PAR_21.png)
...
![nested LOOP_27 Internal Diagram](images/nested_ref_audit_pdc2021_110101_nested_LOOP_27.png)
...
![nested LOOP_29 Internal Diagram](images/nested_ref_audit_pdc2021_110101_nested_LOOP_29.png)
...
### `[nested PAR_28]`
- **Internal Structure:** `{(t55 ∗ τ), [(t56 ∗ τ) │ τ]}`
- **Block Frequency:** 622



![nested PAR_28 Internal Diagram](images/nested_ref_audit_pdc2021_110101_nested_PAR_28.png)

### `[nested PAR_26]`
- **Internal Structure:** `{[τ │ (t52 ∗ τ)], (t55 ∗ τ), [(t56 ∗ τ) │ τ]}`
- **Block Frequency:** 622



![nested PAR_26 Internal Diagram](images/nested_ref_audit_pdc2021_110101_nested_PAR_26.png)

### `[nested LOOP_18]`
- **Internal Structure:** `(⟨[τ │ t46], [(t69 ∗ τ) │ (t70 ∗ τ) │ ⟨[τ │ ⟨t47, [τ │ t37]⟩], [τ │ {(t62 ∗ τ), (t48 ∗ τ), (t68 ∗ τ)}], {[τ │ (t52 ∗ τ)], (t55 ∗ τ), [(t56 ∗ τ) │ τ]}⟩], [τ │ t65]⟩ ∗ τ)`
- **Block Frequency:** 250

- **Max Loop Iterations:** `692`
- **Max Sub-Sequence Length:** `1385` steps (if one case consumes all iterations)

![nested LOOP_18 Internal Diagram](images/nested_ref_audit_pdc2021_110101_nested_LOOP_18.png)

### `[nested PAR_12]`
- **Internal Structure:** `{[(t40 ∗ τ) │ τ], ⟨[(⟨t39, [⟨[τ │ ⟨t43, (t44 ∗ τ)⟩], (t36 ∗ τ)⟩ │ τ]⟩ ∗ t32) │ τ], (⟨[τ │ t46], [(t69 ∗ τ) │ (t70 ∗ τ) │ ⟨[τ │ ⟨t47, [τ │ t37]⟩], [τ │ {(t62 ∗ τ), (t48 ∗ τ), (t68 ∗ τ)}], {[τ │ (t52 ∗ τ)], (t55 ∗ τ), [(t56 ∗ τ) │ τ]}⟩], [τ │ t65]⟩ ∗ τ)⟩}`
- **Block Frequency:** 250



![nested PAR_12 Internal Diagram](images/nested_ref_audit_pdc2021_110101_nested_PAR_12.png)

### `[nested PAR_8]`
- **Internal Structure:** `{[τ │ (t34 ∗ τ)], ⟨[τ │ ⟨t26, t27, [t28 │ τ]⟩], ((t42 ∗ τ) ∗ t41), [τ │ t71], {[(t40 ∗ τ) │ τ], ⟨[(⟨t39, [⟨[τ │ ⟨t43, (t44 ∗ τ)⟩], (t36 ∗ τ)⟩ │ τ]⟩ ∗ t32) │ τ], (⟨[τ │ t46], [(t69 ∗ τ) │ (t70 ∗ τ) │ ⟨[τ │ ⟨t47, [τ │ t37]⟩], [τ │ {(t62 ∗ τ), (t48 ∗ τ), (t68 ∗ τ)}], {[τ │ (t52 ∗ τ)], (t55 ∗ τ), [(t56 ∗ τ) │ τ]}⟩], [τ │ t65]⟩ ∗ τ)⟩}⟩}`
- **Block Frequency:** 250
