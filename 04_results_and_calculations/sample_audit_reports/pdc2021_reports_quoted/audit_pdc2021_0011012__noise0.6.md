...
| **Noise Threshold** | `0.6` |
| **Fitness** | `0.7107553621735029` |
| **Precision** | `0.8163211755444765` |
...
| **Data Exposure (Confirmed % of Claimed Volume)** | `98.36%` |
| **Data Exposure, ST-only (% confirmed)** | `97.87%` |
| **Data Exposure, ST + ST-in-PAR (% confirmed)** | `98.19%` |
...
![Original PM4Py Tree](images/orig_tree_audit_pdc2021_0011012__noise0.6.png)


```text
->( 't10', X( 't11', ->( 't06', 't04' ) ), X( tau, 't05' ), X( 't15', ->( X( tau, 't16' ), 't20' ) ), +( *( 't17', tau ), ->( 't21', 't24', 't23' ) ), 't22', 't34', 't26', 't27', 't28', 't42', 't39', X( 't71', ->( X( tau, ->( 't43', 't44' ) ), X( ->( X( tau, 't40' ), 't36', 't46' ), ->( 't47', +( ->( 't56', 't62' ), ->( 't48', 't68' ) ) ) ), X( 't69', 't70' ), 't65' ) ), 't55' )
```

## Assimilated Master Tree

![Assimilated Master Tree](images/custom_tree_audit_pdc2021_0011012__noise0.6.png)
...
| `[ST]` | `⟨t39, τ⟩` | Exact Token Match | $\ge$ 129 | **357** | ✅ **VERIFIED** |
...
- **AS-Opaque Volume (% of N):** 0.00%
- **Data Exposure (Confirmed % of Claimed Volume):** 98.36%
- **Data Exposure, ST-only (% of claimed ST volume confirmed in log):** 97.87%
- **Data Exposure, ST + ST-in-PAR (% of claimed volume confirmed in log):** 98.19%
...
![nested LOOP_2 Internal Diagram](images/nested_ref_audit_pdc2021_0011012__noise0.6_nested_LOOP_2.png)
...
![nested PAR_1 Internal Diagram](images/nested_ref_audit_pdc2021_0011012__noise0.6_nested_PAR_1.png)
...
![nested PAR_3 Internal Diagram](images/nested_ref_audit_pdc2021_0011012__noise0.6_nested_PAR_3.png)
