...
| **Noise Threshold** | `0.8` |
| **Fitness** | `0.7171020709102639` |
| **Precision** | `0.8661178509532063` |
...
| **Verified Patterns** | `89` |
| **Discrepancy Patterns** | `12` |
| **Ghost Patterns** | `1` |
| **Nested LOOPs** | `12` |
| **Nested PARs** | `6` |
| **Tree Exposure (Strict, End-to-End % of N)** | `0.00%` |
| **Tree Exposure (Strict, Fragment-Level % of N)** | `17.51%` |
| **Tree Exposure (Strict, Fragment-Level, >=2 activities, % of N)** | `10.71%` |
| **Tree Exposure (Local-Strict % of N)** | `100.00%` |
| **Tree Exposure (Local-Strict, >=2 activities, % of N)** | `84.96%` |
| **Total Forced Volume (incl. unresolved AS, % of N)** | `0.00%` |
| **AS-Resolved Volume (% of N)** | `0.00%` |
| **AS-Resolved Volume, PAR-only (% of N)** | `0.00%` |
| **AS-Resolved Volume, LOOP-only (% of N)** | `0.00%` |
| **AS-Opaque Volume (% of N)** | `0.00%` |
| **Data Exposure (Confirmed % of Claimed Volume)** | `89.24%` |
| **Data Exposure, ST-only (% confirmed)** | `100.00%` |
| **Data Exposure, ST + ST-in-PAR (% confirmed)** | `100.00%` |
| **Data Coverage, ST-only (% of real log)** | `14.94%` |
| **Data Coverage, ST + ST-in-PAR (% of real log)** | `44.82%` |
| **Data Coverage, Total (% of real log)** | `100.00%` |
| **Max Fractional Exposure (Worst-Case Normalized)** | `1.20%` |
| **Avg Fractional Exposure (Typical-Case Normalized)** | `100.00%` |
| **Mean Absolute Exposure Volume (events/case)** | `13.70` |

---

## Original PM4Py Tree

![Original PM4Py Tree](images/orig_tree_audit_pdc2021_0101010__noise0.8.png)


```text
->( 't10', X( 't06', 't11' ), *( 't04', 't07' ), +( *( 't15', tau ), *( 't05', tau ) ), 't16', 't20', +( *( 't17', tau ), 't21', ->( 't24', 't23' ) ), 't22', +( *( 't34', tau ), ->( 't26', 't27', X( 't71', ->( 't28', *( 't42', 't41' ) ) ), +( *( 't40', tau ), ->( *( ->( 't39', 't43', 't44', *( 't36', tau ) ), 't32' ), *( ->( 't46', X( 't69', 't70', 't47' ), +( 't37', ->( 't48', 't68' ) ), 't65', *( 't56', tau ), *( 't55', tau ) ), tau ) ) ) ) ) )
```

## Assimilated Master Tree

![Assimilated Master Tree](images/custom_tree_audit_pdc2021_0101010__noise0.8.png)
...
| `[ST (in PAR_16)]` | `t37` | Exact Token Match | $\ge$ 356 | **356** | ✅ **VERIFIED** |
| `[ST (in PAR_16)]` | `t48` | Exact Token Match | $\ge$ 356 | **356** | ✅ **VERIFIED** |
| `[ST (in PAR_16)]` | `t68` | Exact Token Match | $\ge$ 356 | **356** | ✅ **VERIFIED** |
| `[ST (in PAR_16)]` | `⟨t48, t68⟩` | Exact Token Match | $\ge$ 356 | **356** | ✅ **VERIFIED** |
| `[AS (in LOOP_15)]` | `[nested PAR_16]` | Exact Token Match | $\ge$ 356 | **356** | ✅ **VERIFIED** |
| `[ST (in LOOP_15)]` | `t65` | Exact Token Match | $\ge$ 963 | **963** | ✅ **VERIFIED** |
| `[ST (in LOOP_17)]` | `t56` | Exact Token Match | $\ge$ 1501 | **1501** | ✅ **VERIFIED** |
| `[ST (in LOOP_15)]` | `⟨t56⟩` | Exact Token Match | $\ge$ 1501 | **1501** | ✅ **VERIFIED** |
| `[ST (in LOOP_18)]` | `t55` | Exact Token Match | $\ge$ 1649 | **1649** | ✅ **VERIFIED** |
| `[ST (in LOOP_15)]` | `⟨t55⟩` | Exact Token Match | $\ge$ 1649 | **1649** | ✅ **VERIFIED** |
| `[ST (in LOOP_15)]` | `⟨τ, t55⟩` | Exact Token Match | $\ge$ 148 | **1649** | ✅ **VERIFIED** |
| `[ST (in LOOP_15)]` | `⟨τ, t56, t55⟩` | Exact Token Match | $\ge$ 538 | **1317** | ✅ **VERIFIED** |
...
| `[ST (in LOOP_15)]` | `⟨τ, τ, t56, t55⟩` | Exact Token Match | $\ge$ 182 | **1317** | ✅ **VERIFIED** |
| `[ST (in LOOP_15)]` | `⟨τ, t65, t56⟩` | Exact Token Match | $\ge$ 459 | **521** | ✅ **VERIFIED** |
...
| `[ST (in LOOP_15)]` | `⟨t56, t55⟩` | Exact Token Match | $\ge$ 1501 | **1317** | ⚠️ **DISCREPANCY** |
| `[ST (in LOOP_15)]` | `⟨t65, t56, t55⟩` | Exact Token Match | $\ge$ 815 | **521** | ⚠️ **DISCREPANCY** |
| `[ST (in LOOP_15)]` | `⟨t65, t56⟩` | Exact Token Match | $\ge$ 815 | **521** | ⚠️ **DISCREPANCY** |
| `[ST (in PAR_11)]` | `⟨[nested XOR_19], [nested XOR_20], [nested XOR_21], [nested XOR_22], t56, t55⟩` | Exact Token Match | $\ge$ 203.0 | **68** | ⚠️ **DISCREPANCY** |
| `[ST (in PAR_11)]` | `⟨[nested XOR_19], [nested XOR_20], [nested XOR_21], [nested XOR_22], [nested XOR_23], t55⟩` | Exact Token Match | $\ge$ 148.0 | **68** | ⚠️ **DISCREPANCY** |
...
## Audit Summary
- **Perfect Pattern Verifications:** 89
...
- **Data Coverage, ST-only (% of real log explained by VERIFIED strict patterns):** 14.94%
- **Data Coverage, ST + ST-in-PAR (% of real log explained):** 44.82%
- **Data Coverage, Total (% of real log explained by any VERIFIED pattern):** 100.00%
- **Max Fractional Exposure (Worst-Case Normalized):** 1.20% (expected length: 2809.50 events)
- **Avg Fractional Exposure (Typical-Case Normalized):** 100.00% (expected length: 18.49 events)
- **Mean Absolute Exposure Volume:** 13.70 events/case
...
![nested LOOP_1 Internal Diagram](images/nested_ref_audit_pdc2021_0101010__noise0.8_nested_LOOP_1.png)
...
![nested LOOP_3 Internal Diagram](images/nested_ref_audit_pdc2021_0101010__noise0.8_nested_LOOP_3.png)
...
![nested LOOP_4 Internal Diagram](images/nested_ref_audit_pdc2021_0101010__noise0.8_nested_LOOP_4.png)
...
![nested PAR_2 Internal Diagram](images/nested_ref_audit_pdc2021_0101010__noise0.8_nested_PAR_2.png)
...
![nested LOOP_6 Internal Diagram](images/nested_ref_audit_pdc2021_0101010__noise0.8_nested_LOOP_6.png)
...
![nested PAR_7 Internal Diagram](images/nested_ref_audit_pdc2021_0101010__noise0.8_nested_PAR_7.png)
...
![nested PAR_5 Internal Diagram](images/nested_ref_audit_pdc2021_0101010__noise0.8_nested_PAR_5.png)
...
![nested LOOP_9 Internal Diagram](images/nested_ref_audit_pdc2021_0101010__noise0.8_nested_LOOP_9.png)
...
![nested LOOP_10 Internal Diagram](images/nested_ref_audit_pdc2021_0101010__noise0.8_nested_LOOP_10.png)
...
![nested LOOP_12 Internal Diagram](images/nested_ref_audit_pdc2021_0101010__noise0.8_nested_LOOP_12.png)
...
![nested LOOP_14 Internal Diagram](images/nested_ref_audit_pdc2021_0101010__noise0.8_nested_LOOP_14.png)

### `[nested LOOP_13]`
- **Internal Structure:** `(⟨t39, [⟨t43, t44, (t36 ∗ τ)⟩ │ τ]⟩ ∗ t32)`
- **Block Frequency:** 375

- **Max Loop Iterations:** `413`
- **Max Sub-Sequence Length:** `827` steps (if one case consumes all iterations)

![nested LOOP_13 Internal Diagram](images/nested_ref_audit_pdc2021_0101010__noise0.8_nested_LOOP_13.png)
...
![nested PAR_16 Internal Diagram](images/nested_ref_audit_pdc2021_0101010__noise0.8_nested_PAR_16.png)
...
![nested LOOP_17 Internal Diagram](images/nested_ref_audit_pdc2021_0101010__noise0.8_nested_LOOP_17.png)

### `[nested LOOP_18]`
- **Internal Structure:** `(t55 ∗ τ)`
- **Block Frequency:** 1649

- **Max Loop Iterations:** `0`
- **Max Sub-Sequence Length:** `1` steps (if one case consumes all iterations)

![nested LOOP_18 Internal Diagram](images/nested_ref_audit_pdc2021_0101010__noise0.8_nested_LOOP_18.png)

### `[nested LOOP_15]`
- **Internal Structure:** `(⟨[t46 │ τ], [t69 │ t70 │ t47 │ τ], [{t37, ⟨t48, t68⟩} │ τ], [t65 │ τ], [(t56 ∗ τ) │ τ], (t55 ∗ τ)⟩ ∗ τ)`
- **Block Frequency:** 1000

- **Max Loop Iterations:** `649`
- **Max Sub-Sequence Length:** `1299` steps (if one case consumes all iterations)

![nested LOOP_15 Internal Diagram](images/nested_ref_audit_pdc2021_0101010__noise0.8_nested_LOOP_15.png)
...
![nested XOR_19 Internal Diagram](images/nested_ref_audit_pdc2021_0101010__noise0.8_nested_XOR_19.png)
...
![nested XOR_20 Internal Diagram](images/nested_ref_audit_pdc2021_0101010__noise0.8_nested_XOR_20.png)

### `[nested XOR_21]`
- **Internal Structure:** `[{t37, ⟨t48, t68⟩} │ τ]`
- **Block Frequency:** 1649



![nested XOR_21 Internal Diagram](images/nested_ref_audit_pdc2021_0101010__noise0.8_nested_XOR_21.png)
...
![nested XOR_22 Internal Diagram](images/nested_ref_audit_pdc2021_0101010__noise0.8_nested_XOR_22.png)

### `[nested XOR_23]`
- **Internal Structure:** `[(t56 ∗ τ) │ τ]`
- **Block Frequency:** 1649



![nested XOR_23 Internal Diagram](images/nested_ref_audit_pdc2021_0101010__noise0.8_nested_XOR_23.png)

### `[nested PAR_11]`
- **Internal Structure:** `{[(t40 ∗ τ) │ τ], ⟨[(⟨t39, [⟨t43, t44, (t36 ∗ τ)⟩ │ τ]⟩ ∗ t32) │ τ], (⟨[t46 │ τ], [t69 │ t70 │ t47 │ τ], [{t37, ⟨t48, t68⟩} │ τ], [t65 │ τ], [(t56 ∗ τ) │ τ], (t55 ∗ τ)⟩ ∗ τ)⟩}`
- **Block Frequency:** 1000



![nested PAR_11 Internal Diagram](images/nested_ref_audit_pdc2021_0101010__noise0.8_nested_PAR_11.png)

### `[nested PAR_8]`
- **Internal Structure:** `{[(t34 ∗ τ) │ τ], ⟨[t26 │ τ], [t27 │ τ], [t71 │ ⟨t28, (t42 ∗ t41)⟩ │ τ], {[(t40 ∗ τ) │ τ], ⟨[(⟨t39, [⟨t43, t44, (t36 ∗ τ)⟩ │ τ]⟩ ∗ t32) │ τ], (⟨[t46 │ τ], [t69 │ t70 │ t47 │ τ], [{t37, ⟨t48, t68⟩} │ τ], [t65 │ τ], [(t56 ∗ τ) │ τ], (t55 ∗ τ)⟩ ∗ τ)⟩}⟩}`
- **Block Frequency:** 1000



![nested PAR_8 Internal Diagram](images/nested_ref_audit_pdc2021_0101010__noise0.8_nested_PAR_8.png)
