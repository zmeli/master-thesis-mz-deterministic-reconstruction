...
| **Noise Threshold** | `0.2` |
| **Fitness** | `0.9682158188424864` |
| **Precision** | `0.6892097843480911` |
...
![Original PM4Py Tree](images/orig_tree_audit_pdc2021_0000101__noise0.2.png)


```text
->( *( 't09', tau ), *( 't10', tau ), X( +( *( 't02', tau ), X( tau, *( 't01', tau ), ->( *( 't06', tau ), *( 't04', tau ), X( 't03', +( *( 't08', tau ), *( 't05', tau ) ) ) ) ) ), ->( X( *( 't11', tau ), 't19' ), X( tau, ->( 't14', X( tau, 't16' ) ) ), 't20', 't17', X( tau, ->( 't15', 't13' ) ), 't21', +( *( 't36', tau ), ->( X( tau, ->( 't24', +( 't23', 't29' ), X( tau, 't25' ), 't26', 't27', X( tau, +( 't30', *( 't71', tau ) ) ), X( tau, 't28' ) ) ), X( tau, 't22' ), *( 't42', tau ), 't38', 't39', X( tau, ->( 't43', 't44' ), 't40', 't34' ), 't33', 't46', X( 't69', 't70', ->( X( tau, 't47' ), +( *( 't62', tau ), 't45', ->( 't48', 't68' ), ->( 't37', 't60' ) ), 't64' ) ), 't65' ) ), 't66' ) ) )
```

## Assimilated Master Tree

![Assimilated Master Tree](images/custom_tree_audit_pdc2021_0000101__noise0.2.png)
...
### `[nested PAR_3]`
- **Internal Structure:** `{(t02 ∗ τ), [τ │ (t01 ∗ τ) │ ⟨[(t06 ∗ τ) │ τ], (t04 ∗ τ), [t03 │ {(t08 ∗ τ), (t05 ∗ τ)}]⟩]}`
- **Block Frequency:** 406
...
### `[nested PAR_12]`
- **Internal Structure:** `{[(t36 ∗ τ) │ τ], ⟨[τ │ ⟨t24, [{t23, t29} │ τ], [τ │ t25], t26, t27, [⟨[τ │ {t30, (t71 ∗ τ)}], [τ │ t28]⟩ │ τ]⟩], [τ │ t22], [(t42 ∗ τ) │ τ], [t38 │ τ], t39, [⟨[τ │ ⟨t43, t44⟩ │ t40 │ t34], [t33 │ τ], [t46 │ τ], [t69 │ t70 │ ⟨[τ │ t47], {(t62 ∗ τ), [t45 │ τ], ⟨t48, [t68 │ τ]⟩, [⟨[t37 │ τ], t60⟩ │ τ]}, [t64 │ τ]⟩], t65⟩ │ τ]⟩}`
- **Block Frequency:** 327
