...
| Metric | Value |
| :--- | :--- |
| **Dataset Name** | `test_02_seq_xor.csv` |
| **Noise Threshold** | `0.0` |
| **Fitness** | `N/A (skipped)` |
...
![Original PM4Py Tree](images/orig_tree_audit_test_02_seq_xor.png)
...
![Assimilated Master Tree](images/custom_tree_audit_test_02_seq_xor.png)
...
| :--- | :--- | :--- | :--- | :--- | :--- |
| `[ST]` | `A` | Exact Token Match | $\ge$ 34 | **34** | ✅ **VERIFIED** |
| `[ST]` | `C` | Exact Token Match | $\ge$ 14 | **14** | ✅ **VERIFIED** |
| `[ST]` | `B` | Exact Token Match | $\ge$ 20 | **20** | ✅ **VERIFIED** |
| `[ST]` | `D` | Exact Token Match | $\ge$ 34 | **34** | ✅ **VERIFIED** |
| `[ST]` | `⟨C, D⟩` | Exact Token Match | $\ge$ 14 | **14** | ✅ **VERIFIED** |
| `[ST]` | `⟨B, D⟩` | Exact Token Match | $\ge$ 20 | **20** | ✅ **VERIFIED** |
| `[ST]` | `⟨A, C, D⟩` | Exact Token Match | $\ge$ 14 | **14** | ✅ **VERIFIED** |
| `[ST]` | `⟨A, B, D⟩` | Exact Token Match | $\ge$ 20 | **20** | ✅ **VERIFIED** |
| `[ST]` | `⟨A, C⟩` | Exact Token Match | $\ge$ 14 | **14** | ✅ **VERIFIED** |
