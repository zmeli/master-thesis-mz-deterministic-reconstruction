...
| Metric | Value |
| :--- | :--- |
| **Dataset Name** | `test_10_nested_par.csv` |
| **Noise Threshold** | `0.0` |
| **Fitness** | `N/A (skipped)` |
...
![Original PM4Py Tree](images/orig_tree_audit_test_10_nested_par.png)
...
![Assimilated Master Tree](images/custom_tree_audit_test_10_nested_par.png)
...
| `[ST (in PAR_1)]` | `C` | Exact Token Match | $\ge$ 20 | **20** | ✅ **VERIFIED** |
| `[ST (in PAR_2)]` | `B` | Exact Token Match | $\ge$ 20 | **20** | ✅ **VERIFIED** |
| `[ST (in PAR_2)]` | `D` | Exact Token Match | $\ge$ 20 | **20** | ✅ **VERIFIED** |
| `[AS (in PAR_1)]` | `[nested PAR_2]` | Exact Token Match | $\ge$ 20 | **20** | ✅ **VERIFIED** |
...
![nested PAR_2 Internal Diagram](images/nested_ref_audit_test_10_nested_par_nested_PAR_2.png)

### `[nested PAR_1]`
- **Internal Structure:** `{C, B, D}`
- **Block Frequency:** 20



![nested PAR_1 Internal Diagram](images/nested_ref_audit_test_10_nested_par_nested_PAR_1.png)
